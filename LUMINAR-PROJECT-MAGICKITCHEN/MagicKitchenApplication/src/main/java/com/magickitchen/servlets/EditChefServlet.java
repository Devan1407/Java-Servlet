...
public class EditChefServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int chefId = Integer.parseInt(request.getParameter("id"));
        ...
        try {
            ...
            out.println("<html><head><title>Edit Chef</title></head><body>");
            out.println("<h2>Edit Chef</h2>");

            if (rs.next()) {
                out.println("<form action='editChef' method='post'>");
